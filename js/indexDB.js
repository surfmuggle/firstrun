      ...
      var indexedDbSample = (function() {
        ...
        if (window.indexedDB) {
          ...
          idbRequest_ = window.indexedDB.open(
          					"Test", // Database ID
           					"A test object store." // Database Description
          );


          // The result of 'open' is _not_ the database.
          // It's a reference to the request to open
          // the db. Listen for its 'success' and 
          // 'error' event and responde appropriately          
        ...
        function idbShow_(e) {
          ...
          // The 'result' attribute of the 'success' event holds
          // the communication channel to the database          
        ...
        function idbSet_() {
          ...
          prot.title = document.getElementById('idb-value').value;
          prot.text = document.getElementById('wmd-input').value
          var request = objectStore.put(prot,
